...
namespace Samples.RestFul
{
    internal static class EmployeesDac
    {
        ...
        {
            int rowAffected = 0;
            string commandText = "INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,commission_pct,manager_id,department_id)" +
            ...
            parameters.Add(new OracleParameter("prmManagerId", e.ManagerId));
            parameters.Add(new OracleParameter("prmDepartmentId", e.DepartmentId));
        ...
        public static int Update(Employee e)
        {
            ...
            buf.Append(" ,manager_id = :prmManagerId");
            buf.Append(" ,department_id = :prmDepartmentId");
